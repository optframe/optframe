This is an LTS example from OptFrame: HFMVRP

This is one of the latest examples, a vehicle
routing problem solved by Vitor Nazário.
...
from a clean and fresh HFMVRPv6 example.
