...
int main(int argc, char** argv) {
  ...
  switch (optionSwitch) {
    ...
    case APEN_REED_SPEEDUP:
      ...
      cout << "Program ended successfully in MG Mode for checking "
              "SpeedUp_MultiThread"
           << endl;
      return r;
      break;
    ...
    case PRICE_COMP_TM:  // Eletricity Price Competition Training Mode
      ...
      cout << "Program ended successfully in Training Mode Eletricity Price"
           << endl;
      return r;
      break;
    ...
    case LOAD_COMP_TM:  // Load Competition Training Mode
      ...
      cout << "Program ended successfully in Load Competition Training Mode"
           << endl;
      return r;
      break;
    ...
    case JAMES_TAYLOR_EUROPEAN_DATASET:  // James Taylor 2007
      ...
      cout << "Program ended successfully in James Taylor Eurpean Dataset Mode"
           << endl;
      return r;
      break;
    ...
    case APEN_TWO_VARIABLES_MULTIVARIATE_FORECASTS:  // James Taylor 2007
      ...
      cout << "Program ended successfully in AE many variables final batch!"
           << endl;
      return r;
      break;
    ...
    case WCCI_CFI_COMP_CALIBRATION:
      ...
      cout << "Program ended successfully in CIF calibration WCCI Conference!"
           << endl;
      return r;
      break;
    ...
    case GENERATE_NONDOMINATED_HFM_MODELS:  // James Taylor 2007
      ...
      cout << "Parabens! Non-dominated solutions successfully have been "
              "generated."
           << endl;
      return r;
      break;
    ...
    default:
      ...
      cout << "Program ended unsuccessfully in DEFAULT Mode! Something went "
              "wrong...."
           << endl;
      return r;
  }
  ...
  // parameters options precision" << endl; 		selfUseMode();
  // exit(1);
  //	}
  //
  //	if (argc != 10)
