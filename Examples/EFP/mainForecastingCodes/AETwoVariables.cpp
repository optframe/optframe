...
int AETwoVariables(int argc, char **argv)
{
	...
	vParametersFiles.push_back("./MyProjects/configParametersLoadCompetition4Colunas");
	...
	for (int n = 0; n < nBatches; n++)
	{
		...
		int nValidationSamples = sol->first.getR().earliestInput + stepsAhead;
