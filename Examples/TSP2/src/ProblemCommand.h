...
public:
   ...
   bool load(string filename, HeuristicFactory<RepTSP, OPTFRAME_DEFAULT_ADS, MemTSP>& hf, map<string, string>& dictionary, map<string, vector<string>>& ldictionary)
   {
      ...
      hf.addComponent(*new NearestNeighborConstructive(p, hf.getRandGen()), "OptFrame:InitialSearch");
      hf.addComponent(*new ConstructiveBestInsertion(p, hf.getRandGen()), "OptFrame:InitialSearch");
      ...
      hf.addComponent(*new NSSeqTSP2Opt<int, OPTFRAME_DEFAULT_ADS, MemTSP>, "OptFrame:NS:NSFind:NSSeq"); // no optimization
      ...
      hf.addComponent(*new NSSeqTSPOrOptk<int, OPTFRAME_DEFAULT_ADS, MemTSP>(1), "OptFrame:NS:NSFind:NSSeq");
      hf.addComponent(*new NSSeqTSPOrOptk<int, OPTFRAME_DEFAULT_ADS, MemTSP>(2), "OptFrame:NS:NSFind:NSSeq");
      hf.addComponent(*new NSSeqTSPOrOptk<int, OPTFRAME_DEFAULT_ADS, MemTSP>(3), "OptFrame:NS:NSFind:NSSeq");
      //hf.addComponent(*new NSSeqTSPOrOpt<int, OPTFRAME_DEFAULT_ADS, MemTSP>, "OptFrame:NS:NSFind:NSSeq");
      hf.addComponent(*new NSSeqTSPSwap<int, OPTFRAME_DEFAULT_ADS, MemTSP>, "OptFrame:NS:NSFind:NSSeq");
