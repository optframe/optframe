This is an LTS example from OptFrame: MODM

This is one of the latest examples, a multiobjective
problem solved by Thays Oliveira and Vitor Nazário.
...
from a clean and fresh MODMv6 example.
