...
static bool
comparacao(pair<double, int> a, pair<double, int> b)
{
   return (a.first > b.first);
}

static bool
comparacaoClients(int a, int b)
{
   return (a > b);
}
...
public:
   ConstructiveBasicGreedyRandomized(ProblemInstance& _pMODM, RandGen& _rg, MODMADSManager& _adsMan)
