...
then echo "g++ --std=c++20 $workdir/main$project.cpp $workdir/$project/ProblemInstance.cpp $workdir/$project/Evaluator.cpp ../src/OptFrame/Scanner++/Scanner.cpp -o MyProjects/app_$project"
elif [ $nbNS -eq 0 ];
then echo "g++ --std=c++20 $workdir/main$project.cpp $workdir/$project/ProblemInstance.cpp $workdir/$project/Evaluator.cpp $workdir/$project/Constructive$constructive.cpp ../src/OptFrame/Scanner++/Scanner.cpp -o MyProjects/app_$project"
elif [ $nbISG -eq 0 ];
then echo "g++ --std=c++20 $workdir/main$project.cpp $workdir/$project/ProblemInstance.cpp $workdir/$project/Evaluator.cpp $workdir/$project/NSSeq$neighborhood.cpp ../src/OptFrame/Scanner++/Scanner.cpp -o MyProjects/app_$project"
else echo "g++ --std=c++20 $workdir/main$project.cpp $workdir/$project/ProblemInstance.cpp $workdir/$project/Evaluator.cpp $workdir/$project/Constructive$constructive.cpp $workdir/$project/NSSeq$neighborhood.cpp ../src/OptFrame/Scanner++/Scanner.cpp -o MyProjects/app_$project"
fi
echo
