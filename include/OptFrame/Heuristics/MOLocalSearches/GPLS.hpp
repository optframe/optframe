...
public:
   GeneralParetoLocalSearch(sref<MultiEvaluator<S, XEv, XMEv>> _mev, sref<InitialPareto<XMES>> _init_pareto, int _init_pop_size, vsref<MOLocalSearch<XMES, XMEv>> _vLS)
