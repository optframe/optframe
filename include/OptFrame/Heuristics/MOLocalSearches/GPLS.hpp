...
class paretoManagerGPLS : public paretoManager<S, XMEv, XMES> {
 ...
 public:
  ...
  paretoManagerGPLS(MultiEvaluator<XMES>& _mev, int _r)
...
class GeneralParetoLocalSearch : public MOLocalSearch<XMES, XMEv> {
 ...
 public:
  GeneralParetoLocalSearch(sref<MultiEvaluator<XMES>> _mev, sref<InitialPareto<XMES>> _init_pareto, int _init_pop_size, vsref<MOLocalSearch<XMES, XMEv>> _vLS)
