// NOTE, IS THERE SOME ASSIGNMENT HERE??
// IS sref<X> x = ...; then x= ... REBIND?
// IS IT ALLOWED OR NOT? DOES IT SLICE OBJECT, AS A REF TYPE?
//
// IF WE DISABLE ASSIGNMENT, ITS BETTER, FOR MANY REASONS!
// FIRST, WE REMOVE ANY DOUBT, WITHOUT LOSING ANY FUNCTIONALITY...
//     ONE CAN STILL DEREFERENCE AND DO THE ASSIGNMENT, AND IT'S CRISTAL CLEAR
// SECOND, WE FOUND VERY DANGEROUS TO HAVE AUTOMATIC COPY ON CONSTRUCTOR...
//   SO, IF WE DISABLE, WE BREAK SOME ASSUMPTION THAT auto x = y; should do the
//   same as in x = y (WHY NOT??). SO, DANGEROUS AND CONFUSING!
//  ON GENERAL, FOLLOW THE SAME IDEA FROM opview class...
//  SAME IDEA, SAME DILEMA, SAME SOLUTION :)
// CHANGED!!
