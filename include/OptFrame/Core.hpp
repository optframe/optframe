...
#ifndef OPTFRAME_CORE_HPP
#define OPTFRAME_CORE_HPP

// Core Module: inclusion of main OptFrame components, IN ORDER!

// #include <OptFrame/Component.hpp>  // NOT part of Core!
//
