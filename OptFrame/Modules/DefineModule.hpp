...
#define DEFINEODULE_HPP_

#include "../OptFrameTestModule.hpp"

template<class R, class M>
class DefineModule : public OptFrameTestModule<R,M>
{
public:
	string id()
	{
	...
	void run(vector<OptFrameTestModule<R,M>*>, HeuristicFactory<R,M>*, map<string,string>* dictionary, string rest)
	{
