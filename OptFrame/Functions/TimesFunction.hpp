...
#ifndef OPTFRAME_TIMES_FUNCTION_HPP_
#define OPTFRAME_TIMES_FUNCTION_HPP_
...
class TimesFunction : public OptFrameFunction
{
public:

	virtual ~TimesFunction()
	{
	}
...
#endif /* OPTFRAME_TIMES_FUNCTION_HPP_ */
