/*
 * OptFrameTestModule.hpp
 *
 * LGPLv3
 *
 */

#ifndef OPTFRAMETESTMODULE_HPP_
#define OPTFRAMETESTMODULE_HPP_
...
class OptFrameTestModule
{
protected:
	void run_module(string mod, vector<OptFrameTestModule<R,M>*> v, HeuristicFactory<R,M>* f, map<string,string>* dictionary, string input)
	{
...
public:
	...
	virtual void run(vector<OptFrameTestModule<R,M>*>, HeuristicFactory<R,M>*, map<string,string>* dictionary, string) = 0;
