...
public:
   MoveSwap(int _i, int _j, ProblemInstance& _pPN)
     : i(_i)
     , j(_j)
     , pPN(_pPN)
   {
...
public:
   ...
   NSIterator<RepPN, MY_ADS>* getIterator(const RepPN& rep, const MY_ADS*) override
   {
   ...
   Move<RepPN, MY_ADS>* randomMove(const RepPN& rep, const MY_ADS*);
