...
class MoveSwapCorner : public Move<RepEtII>
{
protected:
   int x1, y1, x2, y2;
...
class NSIteratorSwapCorner : public NSIterator<RepEtII>
{
private:
   int x1, y1, x2, y2;
   int nRows, nCols;
...
class NSSeqSwapCorner : public NSSeq<RepEtII>
{
private:
   RandGen& rg;

public:
   NSSeqSwapCorner(RandGen& _rg)
     : rg(_rg)
   {
   }
