...
class MoveSWAP : public Move<SolutionMODM>
{
private:
...
class NSIteratorSWAP : public NSIterator<SolutionMODM>
{
private:
   ProblemInstance* dmproblem;
   int y, c1, c2;
...
class NSSeqSWAP : public NSSeq<SolutionMODM>
{
private:
   ProblemInstance* dmproblem;
   RandGen& rg;
...
public:
   ...
   {
      stringstream ss;
      ss << NS<SolutionMODM>::idComponent() << ":NSSeqSWAP";
      return ss.str();
   }
