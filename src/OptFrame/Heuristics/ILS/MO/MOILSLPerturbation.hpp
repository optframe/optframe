...
public:
	...
	virtual void perturb(S& s, MultiEvaluation<>& mev, const StopCriteria<>& stopCriteria, int level) = 0;
...
public:
	...
	void perturb(S& s, MultiEvaluation<>& mev, const StopCriteria<>& stopCriteria, int level)
	{
